var Vue = (function (exports) {
  ...
  */
  ...
  function baseCreateRenderer(options, createHydrationFns) {
      ...
      const patch = (n1, // 上次渲染结果，初始化时为null
      n2, // 最新的vnode
      container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = false, optimized = false) => {
      ...
      const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
          ...
          // 副作用effect，组件更新函数添加为副作用函数，将来如果数据发生变化，重新执行组件更新函数
